      ...
      <LessonSection>
        <Table striped>
          ...
          <TR>
            ...
            <TD><b>footer:</b> used once at teh bottom of the page and typically contains links, copyright, contact information, etc.</TD>
          </TR>
          <TR>
          ...
          <TR>
            ...
            <TD>
              ...
              <img src={iImageImage}  className={styles.imgSmall}/>
            </TD>
          </TR>
          <TR>
            <TD>
