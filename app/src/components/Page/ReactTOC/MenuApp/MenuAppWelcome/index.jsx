...
const MenuAppWelcome = (props) => {
  return (
    ...
    >
      ...
      <LessonSection
        title='What you get to start with'
        level={2}
      >
        <UL>
      ...
      <LessonSection
        title='Make the React components work first'
        level={2}>
