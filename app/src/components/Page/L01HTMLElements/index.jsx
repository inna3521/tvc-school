    ...
    >
      ...
      <section>
        ...
        <ul>
          ...
          <li><b>stack overflow</b> is a very well moderated discussion forum. It is an excellent resource and you should definately make use of it. It can be more difficult to read than W3Schools or MDN, but do give it a try.</li>
        </ul>
        <Img
          src={iSearchResults}
          alt=""
