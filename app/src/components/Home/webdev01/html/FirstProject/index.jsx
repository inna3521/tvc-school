  ...
  return (
    <div>
      ...
      <Section title='Create the Project Folder and Files'>
        ...
        <Section title='Add HTML' l2>
          <VideoStep src={`${mediaRoot}add-html.mp4`}>
            <Step>Put your cursor on line 8 between the opening and closing <Html>body</Html> tags.</Step>
        ...
        <Section title='Arrange Windows Side-by-Side' l2>
