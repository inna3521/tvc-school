  ...
  return (
      <Section title='Selectors'>
        ...
        <Section title='Type Selector' l2>
          ...
          <P>Below is a type selector that will select all paragraphs and apply two declarations to each. You can tell it is a type selector because its selector is exactly the same as a HTML element.</P>
          <Pre
            code={[
              'p {',
              '  font-size: 12px;',
        ...
        <Section title='Class Selector' l2>
          <P>You learned about the <i>class</i> attribute in the HTML lesson. The <em>class selector</em> will select all elements with a given class and is the most frequently use type of selector.</P>
