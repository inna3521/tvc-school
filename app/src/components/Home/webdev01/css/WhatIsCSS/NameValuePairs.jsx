  ...
  return (
    <Section title='Review: Key / Value Pairs'>
      ...
      <Section title='Examples' l2>
        ...
        />
        <P>Different properties require different types of values. For example, while value for font-size is number followed by the posfix 'px', the background-color property can take the name of a color or a hex color code.</P>
        <Pre
          language='css'
          code={[
