...
const CodeOfConduct = () => {
  return (
    <div id='CodeOfConduct'>
      <Section title='Rules' l1>
        <Section title='Be considerate' l2>
        ...
        <Section title='Communicate effectively' l2>
