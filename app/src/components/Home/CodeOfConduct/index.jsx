    ...
    <div>
      ...
      <Section title='Rules' level={1}>
        ...
        <Section title='Be helpful & collaborative' level={2}>
          <P>We are all learning together. Members of the community will do their best to offer you help and you are encourage to help others when you can.</P>
        </Section>
