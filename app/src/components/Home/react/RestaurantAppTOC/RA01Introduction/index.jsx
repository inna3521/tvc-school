  ...
  return (
    <div id='RA01Introduction'>
      <Section title='Welcome' l1>
        ...
        <Section title='Who is the Challenge For?' l2>
        ...
        <Section title='What you get to start with' l2>
          <UL>
        ...
        <Section title='What will you build' l2>
        ...
        <Section title='What you will learn' subTitle='Listed by component' l2>
          <Section title='Header (skill level 1)' l3>
            <UL>
          ...
          <Section title='Nav (skill level 2)' l3>
            <UL>
              <LI>Create a new functional component</LI>
            </UL>
          </Section>
          <Section title='Gallery (skill level 3)' l3>
            <UL>
          ...
          <Section title='Menu (skill level 3)' l3>
            <UL>
              <LI>Similar to Gallery but you will be expanding on it later</LI>
            </UL>
          </Section>
          <Section title='Nav - Interactive Navigation (skill level 4)' l3>
            <UL>
          ...
          <Section title='MenuEdit (skill level 4+)' l3>
            <UL>
        ...
        <Section title='Some Words of Advice' l2>
        ...
        <Section title='The Finished App' l1>
